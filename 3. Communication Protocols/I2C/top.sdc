...
set_input_delay -add_delay  -clock [get_clocks {clk}]  2.000 [get_ports {sda}]
...
set_output_delay -add_delay  -clock [get_clocks {clk}]  2.000 [get_ports {scl}]
set_output_delay -add_delay  -clock [get_clocks {clk}]  2.000 [get_ports {sda}]
