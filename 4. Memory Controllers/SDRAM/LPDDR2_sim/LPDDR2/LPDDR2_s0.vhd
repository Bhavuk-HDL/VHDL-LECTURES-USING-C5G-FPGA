...
architecture rtl of LPDDR2_s0 is
	...
	component lpddr2_s0_trk_mm_bridge is
		generic (
			DATA_WIDTH        : integer := 32;
			SYMBOL_WIDTH      : integer := 8;
	...
	end component lpddr2_s0_trk_mm_bridge;

	component lpddr2_s0_seq_bridge is
		generic (
			DATA_WIDTH        : integer := 32;
			SYMBOL_WIDTH      : integer := 8;
			HDL_ADDR_WIDTH    : integer := 10;
	...
	end component lpddr2_s0_seq_bridge;
...
begin
	...
	trk_mm_bridge : component lpddr2_s0_trk_mm_bridge
		generic map (
			DATA_WIDTH        => 32,
			SYMBOL_WIDTH      => 8,
			HDL_ADDR_WIDTH    => 16,
	...
	seq_bridge : component lpddr2_s0_seq_bridge
		generic map (
			DATA_WIDTH        => 32,
			SYMBOL_WIDTH      => 8,
			HDL_ADDR_WIDTH    => 32,
