...
--synthesis_resources = altddio_out 1 cyclonev_clk_phase_select 43 cyclonev_ddio_out 60 cyclonev_io_obuf 2 cyclonev_leveling_delay_chain 43 cyclonev_mem_phy 1 cyclonev_phy_clkbuf 22 cyclonev_pseudo_diff_out 1 LPDDR2_p0_altdqdqs 4 lut 75 tri_bus 1 
 ...
 ARCHITECTURE RTL OF LPDDR2_p0 IS
	 ...
	 SIGNAL	lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_afi_half_clk_reg_2760q	:	STD_LOGIC := '0';
	 ...
	 SIGNAL	lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_afi_clk_reg_2757q	:	STD_LOGIC := '0';
	 SIGNAL	lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_0_2754q	:	STD_LOGIC := '0';
	 ...
	 SIGNAL	lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_avl_clk_reg_2763q	:	STD_LOGIC := '0';
	 SIGNAL  wire_nlO_w988w	:	STD_LOGIC_VECTOR (0 DOWNTO 0);
	 SIGNAL	lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_config_clk_reg_2739q	:	STD_LOGIC := '0';
 ...
 BEGIN
	...
	BEGIN
		IF (afi_half_clk = '1' AND afi_half_clk'event) THEN
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_afi_half_clk_reg_2760q <= wire_ni_w987w(0);
		END IF;
	END PROCESS;
	wire_ni_w987w(0) <= NOT lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_afi_half_clk_reg_2760q;
	...
	BEGIN
		IF (afi_clk = '1' AND afi_clk'event) THEN
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_afi_clk_reg_2757q <= wire_nl_w986w(0);
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_0_2754q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_1_2764q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_2_2765q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_3_2766q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_4_2767q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_5_2768q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_6_2769q <= s_wire_vcc;
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_seq_calib_init_reg_7_2770q <= s_wire_vcc;
		END IF;
	END PROCESS;
	wire_nl_w986w(0) <= NOT lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_afi_clk_reg_2757q;
	...
	BEGIN
		IF (pll_avl_clk = '1' AND pll_avl_clk'event) THEN
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_avl_clk_reg_2763q <= wire_nlO_w988w(0);
		END IF;
	END PROCESS;
	wire_nlO_w988w(0) <= NOT lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_avl_clk_reg_2763q;
	PROCESS (pll_config_clk)
	BEGIN
		IF (pll_config_clk = '1' AND pll_config_clk'event) THEN
				lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_config_clk_reg_2739q <= wire_nO_w985w(0);
		END IF;
	END PROCESS;
	wire_nO_w985w(0) <= NOT lpddr2_p0_lpddr2_p0_acv_hard_memphy_umemphy_config_clk_reg_2739q;
