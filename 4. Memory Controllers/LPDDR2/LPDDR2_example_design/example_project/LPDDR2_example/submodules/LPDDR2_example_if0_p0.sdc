...
foreach { inst } $instances {
	...
	if {[get_collection_size [get_registers -nowarn $pins(avl_phy_ck_pins)]] > 0} {
		set local_pll_avl_phy_clk [ LPDDR2_example_if0_p0_get_or_add_clock_vseries \
	...
	if {[string compare -nocase $pll_driver_core_clock "_UNDEFINED_PIN_"] != 0} {
		set local_pll_driver_core_clk [ LPDDR2_example_if0_p0_get_or_add_clock_vseries \
	...
	if {$::GLOBAL_LPDDR2_example_if0_p0_pll_phase(PLL_NIOS_CLK) > 180} {
	...
	} elseif {$::GLOBAL_LPDDR2_example_if0_p0_pll_phase(PLL_NIOS_CLK) > 0} {
		if {[get_collection_size [get_registers -nowarn $pins(avl_phy_ck_pins)]] > 0} {
