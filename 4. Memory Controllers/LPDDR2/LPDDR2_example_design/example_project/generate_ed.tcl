...
lappend arg_list "--component-param=ADDR_ORDER=1"
...
lappend arg_list "--component-param=MEM_CLK_FREQ=320.0"
lappend arg_list "--component-param=MEM_CLK_FREQ_MAX=533.333"
lappend arg_list "--component-param=MEM_COL_ADDR_WIDTH=11"
...
catch { eval [concat [list exec "D:/intelfpga_lite/18.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_lpddr2_tg_ed] $arg_list] } temp
puts $temp
