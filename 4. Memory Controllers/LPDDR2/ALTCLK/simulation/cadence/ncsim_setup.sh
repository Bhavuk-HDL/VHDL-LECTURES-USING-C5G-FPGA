...
# ACDS 18.1 646 win32 2021.06.13.00:49:11
...
# ----------------------------------------
# If ALTCLK is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ALTCLK_altclkctrl_0.vhd" -work altclkctrl_0 -cdslib ./cds_libs/altclkctrl_0.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/ALTCLK.vhd"                                                                                   
fi
