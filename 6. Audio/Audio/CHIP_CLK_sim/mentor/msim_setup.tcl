...
# ----------------------------------------
# If CHIP_CLK is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.1 646 win32 2021.07.11.16:55:23
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/CHIP_CLK.vho"
}
